...
## Reconciliation als Grundlage für die Verlinkung mit Normadaten
...
In der Runde des Resümees am Ende des Tages wurde mit Vertreter*innen verschiedener technisch orientierter MiniCons über die technische Weiterentwicklung der GND diskutiert. Auch hier war der Datenabgleich ein Thema, insbesondere wurde die Bedeutung von Standards bei der Zusammenarbeit in einer verteilten Infrastruktur wie der GND-Kooperative betont. Zugleich wurde deutlich, wie herausfordernd eine Konsolidierung verschiedener traditioneller bibliothekarischer Datenformate (wie PICA oder MARC) zu einer gemeinsamen Grundlage für den Datenaustausch im Web (z.B. dem [LDS der DNB](https://www.dnb.de/DE/Professionell/Metadatendienste/Datenbezug/LDS/lds_node.html)) ist.