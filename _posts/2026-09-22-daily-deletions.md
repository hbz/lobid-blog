...
Das Team der DigiBib, die den lobid-resources-Index für die [Suche in den Verbunddaten](https://nrw.digibib.net/search/hbzvk) nutzt, hatte von Verbundbibliotheken die Anfrage erhalten, die Löschungen im Index tagesaktuell zu halten. Letzte Woche wurde das Feature durch das lobid-Team fertiggestellt (siehe [lobid-resources-Ticket #2357](https://github.com/hbz/lobid-resources/issues/2357)). Somit sind ab sofort gelöschte Titel am nächsten Tag nicht mehr im Index enthalten.
