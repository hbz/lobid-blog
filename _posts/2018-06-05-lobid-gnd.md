...
## Anreicherungen von EntityFacts

Die Bereitstellung eines [Dumps](https://twitter.com/junicatalo/status/976086235541397504) (der [EntityFacts](http://www.dnb.de/DE/Service/DigitaleDienste/EntityFacts/entityfacts_node.html)-Daten seitens der DNB haben uns dazu ermutigt die Links zu anderen (Norm-)Datenquellen sowie Abbildungen zu einer Entität zu ergänzen.

# Web-API

Das im vorherigen Abschnitt beschriebene JSON-LD indexieren wir in einen [Elasticsearch](https://www.elastic.co/de/products/elasticsearch)-Suchmaschinenindex und bieten die native Elasticsearch-API als Schnittstelle an. Somit sind automatisch alle nützlichen Elasticsearch-Funktionen für interessierte Nutzer verfügbar:
...
<sup>3</sup> Für Details siehe Tickes [#1](https://github.com/hbz/lobid-gnd/issues/1), [#101](https://github.com/hbz/lobid-gnd/issues/101), 